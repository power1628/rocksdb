...
extern ROCKSDB_LIBRARY_API void rocksdb_lru_cache_options_set_high_pri_pool_ratio(rocksdb_lru_cache_options_t*, double);
extern ROCKSDB_LIBRARY_API void rocksdb_lru_cache_options_set_low_pri_pool_ratio(rocksdb_lru_cache_options_t*, double);
