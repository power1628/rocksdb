...
void rocksdb_lru_cache_options_set_high_pri_pool_ratio(rocksdb_lru_cache_options_t* opt, double ratio) {
  opt->rep.high_pri_pool_ratio = ratio;
}
void rocksdb_lru_cache_options_set_low_pri_pool_ratio(rocksdb_lru_cache_options_t* opt, double ratio) {
